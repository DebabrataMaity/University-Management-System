...
urlpatterns = [
    ...
    path('student/<slug:class_id>/placement/',
         views.placement, name='placement'), 

     path('student/<slug:class_id>/notification/',
         views.notification, name='notification'),  
     path('<str:slug>',views.notifyPost,name='notifyPost'), 
    ...
    path('teacher/notify',views.t_notify,name='t_notify'),


      # path('teacher/<int:assign_id>/Report/search', views.search, name="search"),
